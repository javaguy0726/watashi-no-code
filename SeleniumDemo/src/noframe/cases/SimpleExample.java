...
public class SimpleExample {
	public static void main(String[] args) {
		...
		try {
			...
			WebElement button_search = driver.findElement(By
					.xpath("//*[@id='search']//input[@type='button']"));
			...
			List<WebElement> products_name = driver.findElements(By
					.xpath("//div[@id='plist']//li/div[2]"));
