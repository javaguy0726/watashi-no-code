...
/**
 * Smoke-and-mirrors validator servlet for listing 5.12. The zip code must be
 * non-blank and equal to "01826" to be considered valid.
 */
public class ZipCodeValidatorServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (zipCodeValue.length() == 0) {
			...
			result.append("The zip code value of ").append(zipCodeValue)
					.append(" does not match the specified street address").append(stateValue);
		}
